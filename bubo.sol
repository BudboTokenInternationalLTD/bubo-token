...
/**
 * Budbo Token International, LTD utility token smart contract.
 */
contract BuboToken is AbstractToken {
  ...
  /**
   * Create new Budbo Token International, LTD utility token smart contract, with given number of tokens issued
